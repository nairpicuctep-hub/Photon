...
export class ResultScene {
  ...
  enter() {
    ...
    this.buttons = m ? [
      ...
      makeButton({ x: cx - w - 10, y: 470, w, h, label: 'Play Again', primary: true, onClick: () => this.nav.battle({ mode: this.stats.mode || 'endless' }) }),
